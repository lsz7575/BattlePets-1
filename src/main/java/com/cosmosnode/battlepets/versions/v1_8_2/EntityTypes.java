package com.cosmosnode.battlepets.versions.v1_8_2;
...
public enum EntityTypes {
    BLOCK("Armor_Stand", 9999, ArmorStandPlus.class) {},
    ...
    private static void addToMaps(Class clazz, String name, int id) {
        ((Map) Util.getPrivateField("c", net.minecraft.server.v1_8_R2.EntityTypes.class, null)).put(name, clazz);
        ((Map) Util.getPrivateField("d", net.minecraft.server.v1_8_R2.EntityTypes.class, null)).put(clazz, name);
        //((Map)getPrivateField("e", net.minecraft.server.v1_7_R4.EntityTypes.class, null)).put(Integer.valueOf(id), clazz);
        ((Map) Util.getPrivateField("f", net.minecraft.server.v1_8_R2.EntityTypes.class, null)).put(clazz, Integer.valueOf(id));
