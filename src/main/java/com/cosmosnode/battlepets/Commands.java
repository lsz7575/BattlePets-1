...
public class Commands {
    ...
    public static boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("reload")) {
            ...
            return true;
        } else if (args[0].equalsIgnoreCase("removenear")) {
        ...
        } else if (args[0].equalsIgnoreCase("menu") && sender instanceof Player) {
            if (sender.hasPermission("battlepets.menu")) {
                if (BattlePets.pets.containsKey(((Player) sender).getUniqueId())) {
        ...
        } else if (args[0].equalsIgnoreCase("name") && sender instanceof Player) {
            if (sender.hasPermission("battlepets.name")) {
            ...
            com.cosmosnode.battlepets.MobStats stats = BattlePets.statsai.get(type);
            ...
            } else meta.setDisplayName(Language.defaultas.replace("{type}", tipas));
